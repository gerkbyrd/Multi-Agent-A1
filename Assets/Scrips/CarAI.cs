...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarAI : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            var cost = terrain_manager.myInfo.traversability;
            var selected = terrain_manager.myInfo.traversability;
            ...
            do
            {
                ...
                for (int a = -1; a <= 1; a++)
                {
                    for (int b = -1; b <= 1; b++)
                    {
                        ...
                        int candidate_j = terrain_manager.myInfo.get_i_index(last.z) + b;
                        if ((candidate_i < 0 || candidate_i >= X) || (candidate_j < 0 || candidate_j >= Z ) || (trav[candidate_i, candidate_j] < 1) || selected[candidate_i, candidate_j] >= 1f)
                        {
                        continue;
                         }
                        if (cost[candidate_i, candidate_j] < chosen_cost)
                        {
